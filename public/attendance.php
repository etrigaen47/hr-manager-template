  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <h1 class="text-primary mb-3">Employee Attendance & Metrics</h1>
          <div class="row">
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Attendance Clock In</h4>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>53275531</td>
                          <td>12 March 2023</td>
                          <td><label class="badge badge-danger">Present</label></td>
                        </tr>
                        <tr>
                          <td>Messsy</td>
                          <td>53275532</td>
                          <td>12 March 2023</td>
                          <td><label class="badge badge-warning">Signed Out</label></td>
                        </tr>
                        <tr>
                          <td>John</td>
                          <td>53275533</td>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Porject Follow-Up</h4>
                  <div class="table-responsive">
